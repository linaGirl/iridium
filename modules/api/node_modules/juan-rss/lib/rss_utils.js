...
utils.generateXML = function (rssObj) {
  ...
  var keysToRemove =  [ 'title', 'description', 'feed_url', 'link', 'site_url'
                      ...
                      , 'generator', 'xmlAddAttr', 'xml', 'item', 'items', "_xmlAttr" ];
  ...
  rssObj.items.forEach(function(item) {
    ...
    if (item.date) {
      item_values.push({ pubDate: { _cdata: new Date(item.date).toGMTString() } });
    }
  ...
  var xmlAttr = { 'xmlns:atom'    : 'http://www.w3.org/2005/Atom' };
